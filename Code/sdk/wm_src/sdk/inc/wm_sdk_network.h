...
#ifndef __WM_SDK_NETWORK_H__
#define __WM_SDK_NETWORK_H__
 ...
 */
wm_SdkResult wm_sdk_network_set_cfun(UINT32 cfun);
 ...
 * @return wm_SdkResult - 0 success; negative on failure.
 */
wm_SdkResult wm_sdk_network_get_cfun(UINT32 *cfun);
 ...
 * @return wm_SdkResult - 0 success; negative on failure.
 */
wm_SdkResult wm_sdk_network_get_creg(wm_SdkNetRegStatus *status);
 ...
 * @return wm_SdkResult - 0 success; negative on failure.
 */
wm_SdkResult wm_sdk_network_get_cgreg(wm_SdkNetRegStatus *status);
 ...
 * @return wm_SdkResult - 0 success; negative on failure.
 */
wm_SdkResult wm_sdk_network_get_cgatt(wm_SdkNetAttStatus *status);
 ...
 * @return wm_SdkResult - 0 success; negative on failure.
 */
wm_SdkResult wm_sdk_network_set_pdp_context(UINT32 cid, const char *apn_type, const char *apn);
 ...
 * @return wm_SdkResult - 0 success; negative on failure.
 */
wm_SdkResult wm_sdk_network_activate_pdp(UINT32 activate, UINT32 cid);
 ...
 * @return wm_SdkResult - 0 success; negative on failure.
 */
wm_SdkResult wm_sdk_network_get_ip_address(UINT32 cid, wm_SdkIpAddress *ip_addr);

/**
 * @brief  Query overall network status.
 * @return wm_SdkResult - 0 = up/registered; negative otherwise.
 */
wm_SdkResult wm_sdk_network_get_network_status(void);
 ...
 * @return wm_SdkResult - 0 success; negative on failure.
 */
wm_SdkResult wm_sdk_network_get_sim_pin_status(UINT8 *pin_status);
 ...
 *                     held by another operation (e.g. an SMS send), in which
 *                     case 'info' is untouched and the caller should retry;
 *                     negative on failure.
 */
wm_SdkResult wm_sdk_network_get_gps_radio_info(wm_SdkNetworkGpsRadioInfo *info);
 ...
 * @return wm_SdkResult - 0 success; negative on failure.
 */
wm_SdkResult wm_sdk_network_get_time(wm_SdkNetworkTime *time);
 ...
 * @return wm_SdkResult - 0 success; negative on failure.
 */
wm_SdkResult wm_sdk_network_set_rtc(const wm_SdkNetworkTime *time);
 ...
 * @return wm_SdkResult - 0 success; negative on failure.
 */
wm_SdkResult wm_sdk_network_rtc_get_local_time(wm_SdkNetworkTime *time);
 ...
 * @return wm_SdkResult - 0 success; negative on failure.
 */
wm_SdkResult wm_sdk_network_rtc_get_utc_time(wm_SdkNetworkTime *time);
 ...
 * @return wm_SdkResult - 0 success; negative on failure.
 */
wm_SdkResult wm_sdk_network_get_ctzu(UINT32 *ctzu);
 ...
 * @return wm_SdkResult - 0 success; negative on failure.
 */
wm_SdkResult wm_sdk_network_set_ctzu(UINT32 enable);

#ifdef __cplusplus
}
#endif

#endif /* __WM_SDK_NETWORK_H__ */
